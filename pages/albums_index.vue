...
<template>
  ...
  <NuxtLink :to="album._path">
    <p> Nacionalidad: {{album.image}}</p>
    <img class="u-max-full-width" :src="album.image ? '/static/images/' + album.image : '/static/images/movies/Black-Panther-Wakanda-Forever-Soundtrack.jpg'" alt="">
