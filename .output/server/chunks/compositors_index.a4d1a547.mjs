...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-8f2c915d>`);
  _push(ssrRenderComponent(_component_HeaderView, null, null, _parent));
  _push(`<h2 style="${ssrRenderStyle({ "margin-top": "15px" })}" data-v-8f2c915d>Compositores</h2><p data-v-8f2c915d>Esta secci\xF3n presenta informaci\xF3n sobre compositores.</p><div class="container centered-content" data-v-8f2c915d><ul data-v-8f2c915d>`);
  _push(ssrRenderComponent(_component_ContentList, { path: "/compositors" }, {
    default: withCtx(({ list }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="grid-container" data-v-8f2c915d${_scopeId}><!--[-->`);
        ssrRenderList(list, (compositor) => {
          _push2(`<span class="grid-item" data-v-8f2c915d${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            to: compositor._path
          }, {
            default: withCtx((_, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img class="u-max-full-width"${ssrRenderAttr("src", "/static/images/" + compositor.image)} alt="Descripci\xF3n de la imagen" data-v-8f2c915d${_scopeId2}>`);
                ...
                _push3(`<p class="goto" data-v-8f2c915d${_scopeId2}>`);
                _push3(ssrRenderComponent(_component_NuxtLink, {
                  to: compositor._path
                }, {
                  default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`Ver compositor<i class="fa-solid fa-chevron-right" style="${ssrRenderStyle({ "color": "#000000" })}" data-v-8f2c915d${_scopeId3}></i>`);
                    } else {
                      return [
...
const compositors_index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8f2c915d"]]);

export { compositors_index as default };
//# sourceMappingURL=compositors_index.a4d1a547.mjs.map
