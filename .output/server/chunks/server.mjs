import { getCurrentInstance, ref, onServerPrefetch, toRef, isRef, computed, defineAsyncComponent, defineComponent, inject, provide, h, Suspense, Transition, reactive, Text, resolveComponent, useSSRContext, watch, useSlots, toRefs, unref, watchEffect, markRaw, mergeProps, withCtx, createTextVNode, createVNode, shallowRef, createApp, onErrorCaptured } from 'vue';
