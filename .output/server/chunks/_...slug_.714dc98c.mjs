...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-6dc78488>`);
  _push(ssrRenderComponent(_component_HeaderView, null, null, _parent));
  _push(`<div data-v-6dc78488>`);
  _push(ssrRenderComponent(_component_ContentDoc, null, {
    default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h4 data-v-6dc78488${_scopeId}>${ssrInterpolate(doc.name)}</h4><div class="content-section" data-v-6dc78488${_scopeId}><div class="image-and-title" data-v-6dc78488${_scopeId}><div class="image-column" data-v-6dc78488${_scopeId}><img${ssrRenderAttr("src", "/images/" + doc.image)} data-v-6dc78488${_scopeId}></div><div class="title-column" data-v-6dc78488${_scopeId}><div data-v-6dc78488${_scopeId}><p data-v-6dc78488${_scopeId}> Nacionalidad: ${ssrInterpolate(doc.nationality)}</p><p data-v-6dc78488${_scopeId}>A\xF1o de nacimiento: ${ssrInterpolate(doc.birth_year)}</p><p data-v-6dc78488${_scopeId}>Fields: ${ssrInterpolate(doc.fields)}</p></div><div class="info-section" data-v-6dc78488${_scopeId}><pre data-v-6dc78488${_scopeId}></pre>`);
        _push2(ssrRenderComponent(_component_ContentRenderer, { value: doc }, null, _parent2, _scopeId));
        _push2(`<ul data-v-6dc78488${_scopeId}>`);
          ...
          default: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              ssrRenderList(data, (album) => {
                _push3(`<li data-v-6dc78488${_scopeId2}>`);
        ...
        _push2(`</ul></div></div></div></div><div data-v-6dc78488${_scopeId}></div>`);
      } else {
        return [
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6dc78488"]]);

export { ____slug_ as default };
//# sourceMappingURL=_...slug_.714dc98c.mjs.map
