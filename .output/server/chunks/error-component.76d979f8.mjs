...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.26aa6bb6.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.accae56a.mjs'));
...
//# sourceMappingURL=error-component.76d979f8.mjs.map
