...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.0a7ef00b.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.a7e61f77.mjs'));
...
//# sourceMappingURL=error-component.36e83333.mjs.map
