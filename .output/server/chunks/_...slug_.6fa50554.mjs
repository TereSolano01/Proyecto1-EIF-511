...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-2204e444>`);
  _push(ssrRenderComponent(_component_HeaderView, null, null, _parent));
  _push(`<div data-v-2204e444>`);
  _push(ssrRenderComponent(_component_ContentDoc, null, {
    default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h4 data-v-2204e444${_scopeId}>${ssrInterpolate(doc.title)}</h4><div class="content-section" data-v-2204e444${_scopeId}><div class="image-and-title" data-v-2204e444${_scopeId}><div class="image-column" data-v-2204e444${_scopeId}><img${ssrRenderAttr("src", "/images/" + doc.image)} data-v-2204e444${_scopeId}></div><div class="title-column" data-v-2204e444${_scopeId}><div data-v-2204e444${_scopeId}><p data-v-2204e444${_scopeId}>Compositores: `);
        ...
        _push2(`</p><p data-v-2204e444${_scopeId}> A\xF1o staticacion: ${ssrInterpolate(doc.year)};</p><p data-v-2204e444${_scopeId}>Generos: ${ssrInterpolate(doc.fields)}</p><p data-v-2204e444${_scopeId}>Pelicula: `);
        _push2(ssrRenderComponent(_component_NuxtLink, {
        ...
        _push2(`</p></div><div class="info-section" data-v-2204e444${_scopeId}><pre data-v-2204e444${_scopeId}></pre>`);
        _push2(ssrRenderComponent(_component_ContentRenderer, { value: doc }, null, _parent2, _scopeId));
        _push2(`</div></div></div></div><div data-v-2204e444${_scopeId}></div>`);
      } else {
        return [
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2204e444"]]);

export { ____slug_ as default };
//# sourceMappingURL=_...slug_.6fa50554.mjs.map
