...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-074f7a77>`);
  _push(ssrRenderComponent(_component_HeaderView, null, null, _parent));
  _push(`<h2 style="${ssrRenderStyle({ "margin-top": "15px" })}" data-v-074f7a77>Pel\xEDculas</h2><p data-v-074f7a77>Esta secci\xF3n presenta informaci\xF3n sobre pel\xEDculas.</p><div class="container centered-content" data-v-074f7a77><ul data-v-074f7a77>`);
  _push(ssrRenderComponent(_component_ContentList, { path: "/movies" }, {
    default: withCtx(({ list }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="grid-container" data-v-074f7a77${_scopeId}><!--[-->`);
        ssrRenderList(list, (movie) => {
          _push2(`<span class="grid-item" data-v-074f7a77${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            to: movie._path
          }, {
            default: withCtx((_, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img class="u-max-full-width"${ssrRenderAttr("src", "/static/images/" + movie.image)} alt="Descripci\xF3n de la imagen" data-v-074f7a77${_scopeId2}>`);
                ...
                _push3(`<p class="goto" data-v-074f7a77${_scopeId2}>`);
                _push3(ssrRenderComponent(_component_NuxtLink, {
                  to: movie._path
                }, {
                  default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`Ver pel\xEDcula<i class="fa-solid fa-chevron-right" style="${ssrRenderStyle({ "color": "#000000" })}" data-v-074f7a77${_scopeId3}></i>`);
                    } else {
                      return [
...
const movies_index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-074f7a77"]]);

export { movies_index as default };
//# sourceMappingURL=movies_index.051b61a4.mjs.map
