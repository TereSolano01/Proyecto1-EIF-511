...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.b2d4e508.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.ce0ea252.mjs'));
...
//# sourceMappingURL=error-component.97d3e99c.mjs.map
