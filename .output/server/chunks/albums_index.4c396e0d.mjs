...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-c343a94f>`);
  _push(ssrRenderComponent(_component_HeaderView, null, null, _parent));
  _push(`<h2 style="${ssrRenderStyle({ "margin-top": "15px" })}" data-v-c343a94f>\xC1lbumes</h2><p data-v-c343a94f>Esta secci\xF3n te sumerge en el fascinante mundo de los \xE1lbumes, ofreciendo detalles y datos intrigantes sobre cada uno de ellos.</p><div class="container centered-content" data-v-c343a94f><ul data-v-c343a94f>`);
  _push(ssrRenderComponent(_component_ContentList, { path: "/albums" }, {
    default: withCtx(({ list }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="grid-container" data-v-c343a94f${_scopeId}><!--[-->`);
        ssrRenderList(list, (album) => {
          _push2(`<span class="grid-item" data-v-c343a94f${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            to: album._path
          }, {
            default: withCtx((_, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img class="u-max-full-width"${ssrRenderAttr("src", album.image)} alt="Italian Trulli" data-v-c343a94f${_scopeId2}>`);
                ...
                _push3(`<p class="goto" data-v-c343a94f${_scopeId2}>`);
                _push3(ssrRenderComponent(_component_NuxtLink, {
                  to: album._path
                }, {
                  default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`Ver album<i class="fa-solid fa-chevron-right" style="${ssrRenderStyle({ "color": "#000000" })}" data-v-c343a94f${_scopeId3}></i>`);
                    } else {
                      return [
...
const albums_index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-c343a94f"]]);

export { albums_index as default };
//# sourceMappingURL=albums_index.4c396e0d.mjs.map
