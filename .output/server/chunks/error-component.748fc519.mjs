...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.2c0a9807.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.21557492.mjs'));
...
//# sourceMappingURL=error-component.748fc519.mjs.map
