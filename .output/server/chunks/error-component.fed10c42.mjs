...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.72567198.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.43fed875.mjs'));
...
//# sourceMappingURL=error-component.fed10c42.mjs.map
