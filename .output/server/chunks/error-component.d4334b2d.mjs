...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.2b9626bb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.c03ca230.mjs'));
...
//# sourceMappingURL=error-component.d4334b2d.mjs.map
