...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.a17320ee.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.40685b28.mjs'));
...
//# sourceMappingURL=error-component.b4c27060.mjs.map
