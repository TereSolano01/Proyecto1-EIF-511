...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.d3549516.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.0b22e0d9.mjs'));
...
//# sourceMappingURL=error-component.2a925f5c.mjs.map
